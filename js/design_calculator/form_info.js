...
export const sites = [
    ...
    { name: "Large Site", draftAddition: 4, draftMultiplier: 1 },
    { name: "Medium Site", draftAddition: 3, draftMultiplier: 1 },
    { name: "Small Site", draftAddition: 2, draftMultiplier: 1 },
...
export const backgrounds = [
    ...
    { name: "New CADs", draftAddition: 0, draftMultiplier: 1.25 },
    { name: "Clean PDF", draftAddition: 0, draftMultiplier: 1.5 },
    { name: "PDF/Image", draftAddition: 0, draftMultiplier: 2 },
    { name: "Redraw Layout", draftAddition: 0, draftMultiplier: 2.15 }
];

// Array of drawing sets and the additional hours for rest of drawing
export const drawings = [
    { name: "Full Set", draftAddition: 4, draftMultiplier: 1 },
    { name: "DD Only", draftAddition: 2, draftMultiplier: 1 },
    { name: "CD Only", draftAddition: 2, draftMultiplier: 1 },
...
export const customers = [
    { name: "New Customer", id: "newCustomer", draftMultiplier: 1.2 },
